...
-- Setting parameters from personal file
local opt = vim.opt
...
vim.keymap.set("n", "<leader>e", ":Explore<CR>", { desc = "Opening netrw" })
...
require("lazy").setup({
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			-- vim.keymap.set("n", "<leader>b", ":ls<CR>", { desc = "list buffers" })
